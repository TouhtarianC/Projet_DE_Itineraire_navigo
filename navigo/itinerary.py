    ...
    with GraphDatabase.driver(NEO4J_URI,
        ...
        with driver.session() as session:
            for node in poi_list + restaurant_list + hosting_list + trail_list:
                # copy of new nodes and labels in upper
                # to be consistent with neo4j db
...
def find_next_poi_from_other(start_uuid, start_type, cluster=None):
    ...
    # there's no need to know the cluster as it will be
    # a new one (eg a day after)
    else:
        queryCreateToNextPOI = (
            f"MATCH (start:{start_type} {{UUID:'{start_uuid}'}}) \
            MATCH (m:POI2) WHERE m.UUID <> start.UUID \
...
if __name__ == '__main__':
    ...
    selected_pois = [
        POI(longitude='-0.558869', latitude='44.840617',
            name='Eglise Sainte-Marie de la Bastide', city='Bordeaux',
            city_code=33100, type='POI', category='', notation=3, score=0,
            uuid='1d57ae11-bb1f-49fa-864f-47d814a23d45', cluster=0, rank=None),
        POI(longitude='-0.5644055', latitude='44.8472004',
            name='Parc aux Angéliques', city='Bordeaux', city_code=33000,
            type='POI', category='', notation=3, score=0,
            uuid='32bd6051-31f4-4dd6-87d2-0cf79083fc44', cluster=0, rank=None),
        POI(longitude='-0.5692856', latitude='44.8544511',
            name='Musée du Vin et du Négoce', city='Bordeaux', city_code=33000,
            type='POI', category='', notation=3, score=0,
            uuid='4edfa3f6-be5e-434d-93f3-1916f77c4398', cluster=0, rank=None),
        POI(longitude='-0.5667723', latitude='44.8557187',
            name='Le M.U.R de Bordeaux', city='Bordeaux', city_code=33000,
            type='POI', category='', notation=3, score=0,
            uuid='6dec1235-2d6a-4d50-8ce8-2cc55b366159', cluster=0, rank=None),
        POI(longitude='-0.5819749', latitude='44.8245865',
            name='Jardin des Dames de la Foi', city='Bordeaux',
            city_code=33000, type='POI', category='', notation=3, score=0,
            uuid='048bbb98-4c96-4cd6-bc59-ec022a439a45', cluster=1, rank=None),
        POI(longitude='-0.5811166', latitude='44.8377496',
            name='Jardin de la Mairie', city='Bordeaux', city_code=33000,
            type='POI', category='', notation=3, score=0,
            uuid='15bc6b46-3f95-454c-8601-be162cc59ea4', cluster=1, rank=None),
        POI(longitude='-0.587269', latitude='44.8350088',
            name='Ville de Bordeaux', city='Bordeaux', city_code=33000,
            type='POI', category='', notation=3, score=0,
            uuid='2c1ac0a0-31b7-4b60-ae71-f25b8aa4ba9d', cluster=1, rank=None),
        POI(longitude='-0.5798715', latitude='44.8389326',
            name='Musée des Arts Décoratifs et du Design', city='Bordeaux',
            city_code=33000, type='POI', category='', notation=3, score=0,
            uuid='30b201f4-6c9f-4a86-8dd1-1597de549bf4', cluster=1, rank=None),
        POI(longitude='-0.5701544', latitude='44.8309401',
            name="Musée d'Ethnographie", city='Bordeaux', city_code=33000,
            type='POI', category='', notation=3, score=0,
            uuid='57543147-7467-4739-8d18-48087768c491', cluster=2, rank=None),
        POI(longitude='-0.5725751', latitude='44.8311575',
            name='Place de la Victoire', city='Bordeaux', city_code=33000,
            type='POI', category='', notation=3, score=0,
            uuid='738b0d87-1963-4377-bdbd-5e8576d43bd2', cluster=2, rank=None),
        POI(longitude='-0.575788', latitude='44.8186303',
            name='Eglise Sainte-Geneviève', city='Bordeaux', city_code=33800,
            type='POI', category='', notation=3, score=0,
            uuid='76260c0f-d98f-4ccc-a214-8aef5e731d6a', cluster=2, rank=None),
        POI(longitude='-0.5749079', latitude='44.8354248',
            name="Musée d'Aquitaine", city='Bordeaux', city_code=33000,
            type='POI', category='', notation=3, score=0,
            uuid='82b805c1-118b-4d8f-b819-3efe70e19956', cluster=2, rank=None),
        POI(longitude='-0.5589808', latitude='44.8702832',
            name='Base sous-marine', city='Bordeaux', city_code=33000,
            type='POI', category='', notation=3, score=0,
            uuid='2256e5ad-86a2-41d0-9662-37959c8ba263', cluster=3, rank=None),
        POI(longitude='-0.5359228', latitude='44.87952',
            name="Pont d'Aquitaine", city='Bordeaux', city_code=33000,
            type='POI', category='', notation=3, score=0,
            uuid='29e53f3f-7042-4404-bc27-d9606acc2865', cluster=3, rank=None),
        POI(longitude='-0.5518423', latitude='44.8584526',
            name='Pont Jacques Chaban Delmas', city='Bordeaux',
            city_code=33000, type='POI', category='', notation=3, score=0,
            uuid='7944d999-b6ca-400d-8f8f-72c66f40c2f5', cluster=3, rank=None),
        POI(longitude='-0.58224', latitude='44.849019',
            name='Le petit hôtel Labottière', city='Bordeaux', city_code=33000,
            type='POI', category='', notation=3, score=0,
            uuid='02265ce9-fd4c-4f9a-a343-6c2b33732720', cluster=4, rank=None),
        POI(longitude='-0.584782', latitude='44.846231',
            name='Palais Gallien', city='Bordeaux', city_code=33000,
            type='POI', category='', notation=3, score=0,
            uuid='401149a3-2be5-4de6-aa04-81a7175e2e26', cluster=4, rank=None),
        POI(longitude='-0.5891036', latitude='44.8539365',
            name='Institut culturel Bernard Magrez', city='Bordeaux',
            city_code=33000, type='POI', category='', notation=3, score=0,
            uuid='54627204-7ab8-4aaf-8237-42cf65bbbc14', cluster=4, rank=None),
        POI(longitude='-0.6017074', latitude='44.8533258',
            name='Parc Bordelais', city='Bordeaux', city_code=33000,
            type='POI', category='', notation=3, score=0,
            uuid='78e242cc-2aaa-409c-aa77-5c806c8fe839', cluster=4, rank=None),
        POI(longitude='-0.5762819', latitude='44.843941',
            name='Allées de Tourny', city='Bordeaux', city_code=33000,
            type='POI', category='', notation=3, score=0,
            uuid='056b0813-5e86-4179-a5a9-69a132958bd8', cluster=5, rank=None),
        POI(longitude='-0.57602', latitude='44.842636',
            name='Eglise Notre Dame et Cour Mably', city='Bordeaux',
            city_code=33000, type='POI', category='', notation=3, score=0,
            uuid='092d05f9-429a-4ace-b0ba-ab794e66f445', cluster=5, rank=None),
        POI(longitude='-0.5799471', latitude='44.8484631',
            name='Muséum de Bordeaux', city='Bordeaux', city_code=33000,
            type='POI', category='', notation=3, score=0,
            uuid='12d0e495-055d-4db7-bb0a-d695f64673c2', cluster=5, rank=None),
        POI(longitude='-0.575835', latitude='44.848596',
            name='Jardin public', city='Bordeaux', city_code=33000,
            type='POI', category='', notation=3, score=0,
            uuid='15039d78-a237-4ae3-89be-3ca10de3d180', cluster=5, rank=None),
        POI(longitude='-0.5788044', latitude='44.8782715',
            name='Plage du Lac', city='Bruges', city_code=33520,
            type='POI', category='', notation=3, score=0,
            uuid='35156e21-7de7-4dcb-8028-68ab310e8efa', cluster=6, rank=None),
        POI(longitude='-0.6017062', latitude='44.8794938',
            name='Le parc Ausone', city='Bruges', city_code=33520,
            type='POI', category='', notation=3, score=0,
            uuid='477cf819-96bc-4345-b759-8d22d4e44bb2', cluster=6, rank=None)
    ]
